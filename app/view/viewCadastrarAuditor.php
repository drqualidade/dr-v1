    ...
    <div class="main-panel" style="background-color: #EEE8AA;">
		<nav class="navbar navbar-default" style="background-color: #EEE8AA;">
            <div class="container-fluid">
                ...
                <span data-notify="icon" style="color: black; " class="ti-back-left"> <a href="dadosauditor" style="color:black;">VOLTAR</a></span>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Cadastrar Auditor</h4>
                                <p>Fomulário para cadastro de auditores oficiais.</p>
                            </div>
                            <div class="content">
                                <form action="cadastrandoauditor.php" method="POST">
                                    <div class="row">
                                        <div class="col-md-5">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Senha</label>
                                                <input type="password" name="senha" class="form-control border-input" required="" placeholder="">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Empresa</label>
                                                <input type="text" name="empresa" class="form-control border-input" required="" placeholder="">
                                            </div>
                                        </div>
                                    ...
                                    <div class="text-center">
                                        <button type="submit" class="btn btn-info btn-fill btn-wd">Cadastrar Auditor</button>
                                    </div>
