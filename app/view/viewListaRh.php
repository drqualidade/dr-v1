        ...
        <nav class="navbar navbar-default" style="background-color: #98FB98;">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Lista RH</a>
                </div>
                    ...
                    <a href="cadastrarempresa">
                        <div class="card card2">
                            <div class="content">
                                <div class="row">
                                    <div class="col-xs-5">
                                        <div class="icon-big ico text-center">
                                ...
                                <table class="table table-striped">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                            <a href="listafuncionario?id=<?php echo $dadosBuscados['id']; ?>" style="margin-left: 5px;"><img src="assets/img/view.png" title="VISUALIZAR"></a></td>
