        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Cadastrar Subcategorias</a>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="card">
                            ...
                            <div class="content">
                                <form action="cadastrandosubcategoria?id=<?php echo $idEmpresa; ?>&categoria=<?php echo $idCategoria; ?>" method="POST">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <br>
                                                <button type="submit" class="btn btn-info btn-fill btn-wd">Cadastrar Subcategoria</button>
