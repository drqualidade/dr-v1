...
<div class="wrapper">
    ...
    <div class="main-panel" style="background-color: #FFDAB9;">
        <nav class="navbar navbar-default" style="background-color: #FFDAB9;">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                ...
                                <p>Lista de clientes que se cadastraram no sistema.
                                <p class="category"></p>
                            </div>
                            <div class="content table-responsive table-full-width">
                                <table class="table table-striped">
                                    ...
                                    <?php include 'model/conex.php';
                                        ...
                                        $selecionarCliente = "SELECT * FROM usuario WHERE tipoUsuario = 3";
                                        $selecionarCliente = mysqli_query($conexao, $selecionarCliente);

                                        while($selecionados = mysqli_fetch_assoc($selecionarCliente)){ 

                                     ?>
                                        <tr>
                                            
                                            <td><?php echo $selecionados['nome']; ?></td>
                                            <td><?php echo $selecionados['cpf']; ?></td>
                                            <td><?php echo $selecionados['email']; ?></td>
                                            <td><a href="deletarcliente?id=<?php echo $selecionados['id']; ?>"><img src="assets/img/delete.png" title="DELETAR"></a>
